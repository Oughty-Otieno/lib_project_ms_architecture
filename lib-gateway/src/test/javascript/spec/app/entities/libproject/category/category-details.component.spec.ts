...
import CategoryDetailComponent from '@/entities/libproject/category/category-details.vue';
import CategoryClass from '@/entities/libproject/category/category-details.component';
