...
class BookResourceIT {
    ...
    private static final Integer DEFAULT_FINE_AMOUNT = 1;
    private static final Integer UPDATED_FINE_AMOUNT = 2;
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book()
            ...
            .fine_amount(UPDATED_FINE_AMOUNT)
    ...
    void createBook() throws Exception {
        ...
        assertThat(testBook.getFine_amount()).isEqualTo(DEFAULT_FINE_AMOUNT);
    ...
    @Test
    @Transactional
    void checkFine_amountIsRequired() throws Exception {
        int databaseSizeBeforeTest = bookRepository.findAll().size();
        // set the field null
        book.setFine_amount(null);
    ...
    void getAllBooks() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.[*].fine_amount").value(hasItem(DEFAULT_FINE_AMOUNT)))
    ...
    void getBook() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.fine_amount").value(DEFAULT_FINE_AMOUNT))
    ...
    void putNewBook() throws Exception {
        ...
        assertThat(testBook.getFine_amount()).isEqualTo(UPDATED_FINE_AMOUNT);
    ...
    void partialUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.quantity(UPDATED_QUANTITY);
