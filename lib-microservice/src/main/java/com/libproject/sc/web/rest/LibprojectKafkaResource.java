...
@RestController
@RequestMapping("/api/libproject-kafka")
public class LibprojectKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LibprojectKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LibprojectKafkaResource(KafkaProperties kafkaProperties) {
