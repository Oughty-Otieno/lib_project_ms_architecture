...
/**
 * REST controller for managing {@link com.libproject.sc.domain.Book}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BookResource {
    ...
    private static final String ENTITY_NAME = "libprojectBook";
    ...
    public ResponseEntity<Book> partialUpdateBook(
        ...
        Optional<Book> result = bookRepository
            ...
            .map(existingBook -> {
                ...
                if (book.getFine_amount() != null) {
                    existingBook.setFine_amount(book.getFine_amount());
                }
